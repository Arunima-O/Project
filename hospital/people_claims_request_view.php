                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="age"  value="<?php echo $age;?>" required min="18" max="60">
                        </div>
                      </div>                      
                      <div class="col-md-6">
                        <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="addr"  value="<?php echo $addr;?>" maxlength="12" minlength="12" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
